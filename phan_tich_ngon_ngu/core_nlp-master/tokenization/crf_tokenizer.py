...
class CrfTokenizer(BaseTokenizer):
    def __init__(self, config_root_path="", bi_grams_path='D:/Project/voice_recognization/phan_tich_ngon_ngu/core_nlp-master/tokenization/bi_grams.txt', tri_grams_path='D:/Project/voice_recognization/phan_tich_ngon_ngu/core_nlp-master/tokenization/tri_grams.txt',
                 crf_config_path='D:/Project/voice_recognization/phan_tich_ngon_ngu/core_nlp-master/tokenization/crf_config.txt',
                 features_path='D:/Project/voice_recognization/phan_tich_ngon_ngu/core_nlp-master/tokenization/crf_features.txt',
                 model_path='D:/Project/voice_recognization/phan_tich_ngon_ngu/core_nlp-master/models/vi-segmentation.crfsuite',
